...
5. Cite les sources en fin de réponse.`,b="https://chatgpt.com/?q="+encodeURIComponent(e),s="https://www.perplexity.ai/search/new?q="+encodeURIComponent(e);let t=T("> COPY prompt"),r;function i(){N(r,".ai-modal-backdrop",".ai-modal-content",I())}function l(){Q(r,".ai-modal-backdrop",".ai-modal-content",I())}function q(){navigator.clipboard.writeText(e).then(()=>{v(t,"> COPIED !"),setTimeout(()=>{v(t,"> COPY prompt")},2e3)})}S(()=>z(B.AI_MODAL_OPEN,i));var p=Y(),w=n(p),P=o(w,2),C=n(P),g=o(C,6),y=n(g),k=o(y,2),f=o(k,2),M=n(f,!0);a(f),a(g);var R=o(g,2);X(R,{prompt:e}),a(P),a(p),F(p,A=>r=A,()=>r),_(()=>{x(y,"href",b),x(k,"href",s),h(M,m(t))}),c("click",w,l),c("click",C,l),c("click",f,q),E(d,p),O()}G(["click"]);export{ne as default};
