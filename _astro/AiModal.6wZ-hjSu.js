...
5. Cite les sources en fin de réponse.`,E="https://chatgpt.com/?q="+encodeURIComponent(u),G="https://www.perplexity.ai/search/new?q="+encodeURIComponent(u);let d=w("> COPY prompt"),t=w(!1),i;function T(m){n(t,!1);const R=m?.trigger??document.getElementById("ai-modal-trigger");H(i,".ai-modal-backdrop",".ai-modal-content",R,A())}function b(){n(t,!1),L(i,".ai-modal-backdrop",".ai-modal-content",A())}function q(){n(t,!c(t))}function _(){navigator.clipboard.writeText(u).then(()=>{n(d,"> COPIED !"),setTimeout(()=>{n(d,"> COPY prompt")},2e3)})}V(()=>Y(X.AI_MODAL_OPEN,T));var a=J(),h=o(a),x=e(h,2),g=e(o(x),4),v=o(g),P=e(v,2),s=e(P,2),S=o(s,!0);r(s);var l=e(s,2),M=o(l,!0);r(l);var C=e(l,2);C.textContent=`Voici les informations de référence sur Guillaume PARRAT (GuiGPaP), ingénieur microélectronique, data-scientist, artiste 2D/3D et maker basé en France.
...
3. Attends la réponse avant de continuer.
4. Base-toi sur les informations ci-dessus et les sources listées. Si une info n'est pas disponible, indique "non précisé".
5. Cite les sources en fin de réponse.`,r(g);var y=e(g,2),F=o(y);r(y),r(x),r(a),z(a,m=>i=m,()=>i),U(()=>{f(v,"href",E),f(P,"href",G),I(S,c(d)),I(M,c(t)?"[-] Masquer le prompt":"[+] Voir le prompt"),f(C,"data-open",c(t)||void 0)}),p("click",h,b),p("click",s,_),p("click",l,q),p("click",F,b),O(k,a),N()}B(["click"]);export{ae as default};
